...
export const overrides = {
  ...
  346: { seller: "gotham-graded", title: "Detective Comics (2011)", issue: "#20", publisher: DC, year: 2013, era: "Modern Age", label: "Signature Series (Yellow)", keyIssue: "We Can Be Heroes variant, signed and sketched by Frank Miller", creators: ["John Layman", "Jason Fabok", "Frank Miller"], palette: P.batman, attributes: { Variant: "We Can Be Heroes variant", "Signed by": "Frank Miller, with sketch" }, coverSlug: "detective-comics-20-we-can-be-heroes-blank-var-ed" },
  ...
  398: { seller: "gotham-graded", title: "War Machine", issue: "#1", publisher: MARVEL, year: 1994, era: "Modern Age", label: "Signature Series (Yellow)", keyIssue: "First issue of the 1994 series, signed by Don Cheadle", creators: ["Len Kaminski", "Gabriel Gecko", "Gabriel Gecko"], palette: P.war, attributes: { "Signed by": "Don Cheadle", Edition: "Collector's Edition" }, coverSlug: "war-machine-1-collectors-edition" },
